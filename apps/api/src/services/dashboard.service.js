...
import { getCached, del, generateKey, TTL } from './cache.service.js';

/**
 * Get dashboard statistics from materialized view
 * Cached for 5 minutes (TTL.DASHBOARD) - Phase 3.2
 * @returns {Promise<Object>} Dashboard statistics
 */
export async function getDashboardStats() {
  const cacheKey = generateKey('dashboard', 'stats');
 ...
 * Invalidates cache after refresh - Phase 3.2
